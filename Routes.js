...
router.post("/categorymastergetAll", CategorymasterController.categorymastergetAll);
router.post("/categorymasterAdd", CategorymasterController.categorymasterAdd);
router.post("/categorymasterUpdate", CategorymasterController.categorymasterUpdate);
